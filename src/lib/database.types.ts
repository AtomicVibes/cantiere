  ...
  public: {
    Tables: {
      ...
      project_timeline: {
        ...
        Relationships: [
          {
            foreignKeyName: "project_timeline_document_id_fkey"
            columns: ["document_id"]
            isOneToOne: false
            referencedRelation: "documents"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "project_timeline_responsible_person_id_fkey"
      ...
      projects: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_project_request_cascade"
    ...
    Functions: {
      ...
      check_stale_on_hold_projects: { Args: never; Returns: undefined }
      clear_conversation: {
        Args: { chat_receiver_id: string; chat_sender_id: string }
        Returns: undefined
      }
      create_document_with_audience: {
        Args: {
      ...
      delete_conversation: {
        Args: { current_user_id: string; peer_id: string }
        Returns: undefined
      }
      delete_single_message: {
        Args: { current_user_id: string; msg_id: string }
        Returns: undefined
      }
      ...
      get_role_id: { Args: { role_name: string }; Returns: string }
    ...
    Enums: {
      status_enum: "active" | "inactive" | "on_leave"
    }
    CompositeTypes: {
      [_ in never]: never
    }
